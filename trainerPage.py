...
def main_screen():
    ...
    Label(text = "Course", bg = 'floral white', font = ("Times", "10", "bold"), fg = 'hot pink').pack()
    m = OptionMenu(screen, course, "B.Tech", "BBA", "BCA", "MBA", "Diploma")
    m.configure(bg = 'SeaGreen1')
    m.pack()
    Label(text = "", bg = 'floral white').pack()
    Label(text = "Branch", bg = 'floral white', font = ("Times", "10", "bold"), fg = 'hot pink').pack()
    a = OptionMenu(screen, branch, "CSE", "ME", "EC", "EN","CE")
    a.configure(bg = 'SeaGreen1')
    a.pack()
    Label(text = "", bg = 'floral white').pack()
    Label(text = "Year", bg = 'floral white', font = ("Times", "10", "bold"), fg = 'hot pink').pack()
    w = OptionMenu(screen, year, "First", "Second", "Third", "Fourth")
    w.configure(bg = 'SeaGreen1')
    w.pack()
    Label(text = "", bg = 'floral white').pack()
    Label(text = "Section", bg = 'floral white', font = ("Times", "10", "bold"), fg = 'hot pink').pack()
    b = OptionMenu(screen, section, "A", "B", "C", "D", "E")
    b.configure(bg = 'SeaGreen1')
    b.pack()
    Label(text = "", bg = 'floral white').pack()
    Button(text = "Create training model", fg = "dark violet", bg = "SeaGreen1", height = "2", width = "30", command = lambda : trainer.train(str(year.get()),str(course.get()),str(branch.get()),str(section.get()))).pack()
